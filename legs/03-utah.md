# Leg 3: Utah
**Zion → Bryce Canyon → UT-12 Scenic Drive → Capitol Reef (drive-through) → Moab (Arches, Canyonlands, Dead Horse Point)**
**Dates:** April 19–24 (5 nights, handoff from Grand Canyon, departure toward Seattle on Apr 24)

---

## ⚠️ Key Facts & Watch-Outs

- **Angels Landing permit:** The spring 2026 lottery ran February 13–25 and permits were issued Feb 26. This has passed — Angels Landing is not accessible without a permit. No impact to this trip since moderate hikes are the focus, and there are excellent alternatives.
...
## Celiac Dining Strategy for This Leg

Utah is more challenging than California but has genuine standouts — especially Springdale and Moab. Key principles:

- **Springdale (Zion) is excellent** — Bit & Spur's owner has Celiac disease; this is the most trustworthy stop on the leg.
- **Bryce Canyon area is very limited** — stock the van before arriving and plan to cook dinner at camp.
- **Torrey/Capitol Reef** — better than expected; La Cueva for Mexican is solid.
- **Moab has options** with several restaurants running dedicated fryers.
- **SLC on the return** — Taqueria 27 and Arempas are the best vetted options.
- **Hidden gem:** The Primitive Waffle Cavé in Parowan, UT is the **only 100% dedicated GF café in southern Utah** — worth a detour if passing through (it's near I-15 on the return drive or a short detour from Bryce).

### ⭐ Destination-Worthy Celiac Highlights on This Route

| Restaurant | Location | Why It's Special |
|---|---|---|
| **Bit & Spur Restaurant & Saloon** | Springdale | Owner has Celiac disease. Dedicated fryer/prep. All GF-marked items are truly celiac-safe. |
| **The Primitive Waffle Cavé** | Parowan (near Bryce/I-15) | DEDICATED 100% GF — the only dedicated GF café in all of southern Utah. |
| **Taqueria 27** | Salt Lake City | CELIAC-AWARE. Dedicated kitchen space, dedicated fryer, trained staff. |
| **Arempas** | Salt Lake City | CELIAC-AWARE. Venezuelan arepas, dedicated fryer, nearly all menu items GF. |

Flagged risks: ⚠️ = Celiac concern, ✅ = verified safe

---

## Itinerary Overview (5 Nights)

| Night | Location | Camp |
|-------|----------|------|
| Apr 19 | Zion National Park | Watchman Campground (electric, A/B Loop) |
| Apr 20 | Zion National Park | Watchman Campground (2nd night) |
| Apr 21 | Bryce Canyon | North Campground or Sunset Campground |
| Apr 22 | Moab area | Dead Horse Point State Park |
| Apr 23 | Moab area | Dead Horse Point or BLM dispersed (depart Apr 24) |
...
## Reservations Checklist for This Leg

| Site | Dates | Platform | Priority | Notes |
|------|-------|----------|----------|-------|
| Watchman Campground, Zion (electric — A or B Loop ONLY) | Apr 19–21 | [recreation.gov](https://www.recreation.gov) | 🔴 Urgent | 19ft+ vehicles cannot use non-electric loops |
...
| Park | Entry Requirement | Notes |
|------|-------------------|-------|
| Zion | America the Beautiful pass | No timed entry |
| Bryce Canyon | America the Beautiful pass | No timed entry |
| Capitol Reef | America the Beautiful pass | No timed entry |
| Arches | America the Beautiful pass | Timed entry DROPPED for 2026 |
| Canyonlands | America the Beautiful pass | No timed entry |
| Dead Horse Point | State park day use fee (~$15) | Separate from NPS pass |

---

## Celiac Dining by Town

| Town | Tier | Best Options |
|------|------|-------------|
| Springdale (Zion) | ⭐ Excellent | **Bit & Spur** (owner has Celiac, dedicated fryer/prep — top pick), Camp Outpost Co. Zion (dedicated fryer+prep), Zion Pizza & Noodle Co (GF pizza, celiac-praised), Thai Sapa, GF sorbet shop (dedicated, right outside park entrance) |
| Kanab | Good | **Rocking V Cafe** (97 W Center St — best full dinner, staff trained, menu marks GF+desserts), Wild Thyme Cafe (multiple GF options, positive Celiac reports) |
| Bryce area | ⚠️ Limited | **Stone Hearth Grille** (best option, reserve ahead), IDK BBQ (large GF menu). **Plan to van-cook dinner.** |
| Parowan (~25 min from Bryce) | ⭐ Hidden gem | **The Primitive Waffle Cavé** (88 N Main St) — DEDICATED 100% GF, the only dedicated GF café in southern Utah |
| Torrey/Capitol Reef | Adequate | **La Cueva Restaurante Mexicano** (knowledgeable, zero cross-contamination items), Broken Spur Inn & Steakhouse (GF-knowledgeable) |
| Moab | Good | **98 Center** (dedicated fryer, best dinner), **Sabaku Sushi** (dedicated fryer), Sweet Cravings (proactive protocols — call re: shared oven), Singha Thai, Wrap it Up Mediterranean (dedicated fryer), Quesadilla Mobilla (GF truck) |
| Salt Lake City (return) | ⭐ Excellent | **Taqueria 27** (dedicated kitchen+fryer), **Arempas** (Venezuelan, dedicated fryer, nearly all GF), Zest Kitchen & Bar (100% GF facility — verify current standards after 2025 ownership change) |
...
|---------|-------|------------|
| Grand Canyon (East Entrance) → Zion | 175 | ~2.5 hrs |
| Zion → Bryce Canyon (via Red Canyon) | 84 | ~1.5 hrs |
| Bryce Canyon → Capitol Reef (via UT-12) | 110 | ~2.5 hrs |
| Capitol Reef → Moab | 150 | ~2.5 hrs |
| Moab → Dead Horse Point | 35 | ~40 min |
| Dead Horse Point → Canyonlands (Mesa Arch) | 10 | ~15 min |
| Canyonlands → Arches | 30 | ~35 min |
| Moab → Twin Falls, ID (return Day 1) | 430 | ~6 hrs |
| Twin Falls → Seattle (return Day 2) | 530 | ~7 hrs |
| **Total Utah driving** | **~595 miles** | |

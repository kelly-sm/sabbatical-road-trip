# Leg 4: Return — Moab → Valley of Fire → Yosemite → Crater Lake → Seattle
**Dates:** April 24–28 (4 nights, home on Apr 28)
...
```
Moab, UT
  ↓ I-15 south (~440 mi / ~6 hrs)
Valley of Fire State Park, NV  [Night 19]
  ↓ I-15 → CA-58 → CA-99 → CA-41 (~420 mi / ~6.5 hrs)
Yosemite Valley, CA  [Night 20–21]
  ↓ CA-120 Big Oak Flat → CA-99 → I-5 → OR-138 (~480 mi / ~7.5 hrs)
Near Crater Lake, OR  [Night 22]
  ↓ OR-138 → I-5 north (~465 mi / ~7 hrs)
Seattle, WA  [Home — Apr 28]
```

**Total return driving:** ~1,805 miles over 4 driving days
...
| Site | Date | Platform | Priority | Notes |
|------|------|----------|----------|-------|
| **Valley of Fire — Atlatl Rock or Arch Rock** | Apr 24 | [reserveamerica.com](https://www.reserveamerica.com) | 🟡 Medium | Opens 30 days in advance (~Mar 25). Book now. |
| **Upper Pines, Yosemite Valley** | Apr 25–26 | [recreation.gov](https://www.recreation.gov) | 🔴 Urgent | Window opened Nov 15 — check cancellations daily. Set alert. Or try Yosemite Conservancy guaranteed program. |
| **Diamond Lake Campground, OR** (near Crater Lake) | Apr 27 | [reservenorthwest.com](https://www.reservenorthwest.com) | 🟡 Medium | Or dispersed Umpqua NF. Check if open in late April. |
...
|---------|-------|------------|
| Moab → Valley of Fire (via I-15 south) | 440 | ~6 hrs |
| Valley of Fire → Yosemite (via CA-41 south entrance) | 420 | ~6.5 hrs |
| Yosemite → Crater Lake (via CA-120/I-5/OR-138) | 480 | ~7.5 hrs |
| Crater Lake → Seattle (via I-5 north) | 465 | ~7 hrs |
| **Total return leg** | **~1,805 mi** | **~27 hrs driving** |
